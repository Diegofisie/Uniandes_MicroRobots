...
box on
hold on
magnet_1 = magnetdefine('type','cuboid','dim',[3e-4 1e-3 1e-3],... 
'position',1e-3*[0;0;.5],'magn',0.38,'magdir','x');
...
'position',[-0.3e-3; 0; .5e-3],'magn',0.38,'magdir','x');
%The first magnet es defined with following dimensions 
%2a = lenght = 1mm = 0.02 #Meters
%2b = width = 1mm = 0.012 #Meter
%2c = hight = 0.3 mm = 0.006 #Meter
niquel_1 = magnetdefine('type','cuboid','dim',[3e-4 1e-3 2e-3],... 
'position',[0.3e-3; 0; 1e-3],'magn',0.06,'magdir','z');
niquel_2 = magnetdefine('type','cuboid','dim',[3e-4 1e-3 2e-3],... 
'position',[-0.6e-3; 0; 1e-3],'magn',0.06,'magdir','z');
...
%2b = width = 1mm = 0.012 #Meter
%2c = hight = 0.3 mm = 0.006 #Meter
niquel_1 = magnetdefine('type','cuboid','dim',[2e-3 1e-3 3e-4],... 
'position',[2e-3; 0; 0],'magn',0.06,'magdir','x');
niquel_2 = magnetdefine('type','cuboid','dim',[2e-3 1e-3 3e-4],... 
'position',[-3.5e-3; 0; 0],'magn',0.06,'magdir','x');
%The second magnet es defined with following dimensions 
%2A = lenght = 1mm = 0.02 #Meters
%2B = width = 1mm = 0.012 #Meter
%2C = hight = 0.3 mm = 0.006 #Meter
